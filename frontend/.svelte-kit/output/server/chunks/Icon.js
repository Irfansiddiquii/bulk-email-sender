...
import { c as create_ssr_component, i as compute_rest_props, j as spread, k as escape_object, l as escape_attribute_value, b as each } from "./ssr.js";
...
const toastStore = {
  ...
  danger: (message) => toastStore.show("danger", message),
  info: (message) => toastStore.show("info", message),
  warning: (message) => toastStore.show("warning", message)
};
/**
 * @license lucide-svelte v0.310.0 - ISC
